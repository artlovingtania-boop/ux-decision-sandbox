...
12. links — для кожного блоку масив пар {task, audience}. task — рівно текст однієї із задач у tasks, audience — рівно текст однієї з аудиторій у audiences; не перефразовуй. Аудиторії з droppedAudiences у пари не став. Блок може обслуговувати кілька задач і кілька аудиторій — тоді кілька пар, по одній на кожну комбінацію, де блок справді дає відповідь. Якщо опис блоку називає, кому він адресований, і що він доводить, підтверджує чи показує цій аудиторії, — прив'язка обов'язкова: хоча б одна пара для кожної названої аудиторії, що є в audiences. «Всі» в описі означає кожну аудиторію з audiences. Прив'язка — про призначення блоку, не про готовність змісту: блок не лишається порожнім через те, що зміст ще не наповнений чи стоїть у відкритих питаннях. Порожній масив (links: []) правильний лише для блоку, який задачі не обслуговує за призначенням: навігація, однакова на всіх сторінках; футер з базовою інформацією; смуга логотипів партнерів; перше представлення, в якому немає нічого, крім слогану чи зображення. Ці винятки діють, навіть якщо опис такого блоку називає аудиторію. Блок, що пояснює організацію змістом, — не перше представлення, навіть якщо стоїть одразу після нього. Аудиторію, яку опис блоку не називає, у пари не додавай. Прив'язка ставиться там, де блок дає відповідь на задачу, а не там, де тема згадана поруч.
